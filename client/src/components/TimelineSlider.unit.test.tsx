// src/components/TimelineSlider.unit.test.tsx
...
vi.mock('rc-slider', () => ({
  default: (props: MockSliderProps) => { // replaced `any` with MockSliderProps
    ...
    return (
      <input
        ...
        onChange={(e) => { // toggle array/number payload
          if (!onChange) return;
...
beforeEach(() => {
  ...
  mockState = { // reset state explicitly before each test
